...
for (let i = 0; i < 5; i++) {
  document.querySelector('[wized="home_PropertyContent"] .properties_list').innerHTML += loaderItemHtml;
    ...
    // Remove loader property items
    const loaderItems = document.querySelectorAll(".content-shimmer");
    loaderItems.forEach((loaderItem) => {
      loaderItem.parentNode.remove();
    });
