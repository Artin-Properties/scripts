...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ? define(["exports"], e)
      : e(
          ((t = "undefined" != typeof globalThis ? globalThis : t || self).easepick =
            t.easepick || {})
        );
})(this, function (t) {
  "use strict";
  class e extends Date {
        ...
        if (s.length) {
          ...
          if (o.test(t)) {
            ...
            const d = Number(s[i.minute]),
              ...
              m = s[i.ampm];
            return (
              m && "PM" === m && ((h += 12), 24 === h && (h = 0)), new Date(a, r, c, h, p, g, 0)
            );
          }
        }
      }
    ...
    inArray(t, e = "[]") {
      return t.some((t) =>
        t instanceof Array ? this.isBetween(t[0], t[1], e) : this.isSame(t, "day")
      );
    }
    isBetween(t, e, i = "()") {
      switch (i) {
        ...
        case "[]":
          return (
            this.midnight_ts() >= this.midnight_ts(t) && this.midnight_ts() <= this.midnight_ts(e)
          );
      }
    }
    isBefore(t, e = "days") {
  ...
  (t.AmpPlugin = class extends a {
              ...
              this.lockPlugin &&
                (n.disabled =
                  (this.lockPlugin.options.minDate &&
                    a.isBefore(new e(this.lockPlugin.options.minDate), "month")) ||
                  (this.lockPlugin.options.maxDate &&
                    a.isAfter(new e(this.lockPlugin.options.maxDate), "month"))),
          ...
          for (let t = o; t >= n; t -= 1) {
            ...
            (n.value = String(t)),
              ...
              this.lockPlugin &&
                (n.disabled =
                  (this.lockPlugin.options.minDate &&
                    o.isBefore(new e(this.lockPlugin.options.minDate), "year")) ||
                  (this.lockPlugin.options.maxDate &&
    ...
    (t.LockPlugin = class extends a {
      ...
      testFilter(t) {
        return (
          "function" == typeof this.options.filter && this.options.filter(t, this.picker.datePicked)
        );
      }
    }),
    ...
    (t.RangePlugin = class extends a {
      ...
      updateValues() {
        const t = this.picker.options.element,
          ...
          s =
            i instanceof Date ? i.format(this.picker.options.format, this.picker.options.lang) : "",
          o =
            n instanceof Date ? n.format(this.picker.options.format, this.picker.options.lang) : "";
        if (e)
      ...
      checkIntlPluralLocales() {
        ...
        t.every((t) => e.includes(t)) ||
          console.warn(
            `${this.getName()}: provide locales (${t.join(", ")}) for correct tooltip text.`
          );
      }
      initializeRepick() {
